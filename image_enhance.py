...
class AdvancedLicensePlateRecognizer:
    ...
    def advanced_preprocess_plate(self, plate_image):
        ...
        # Bước 3: Resize ảnh để cải thiện OCR
...
# Chạy test với ảnh
test_with_preview("/content/drive/MyDrive/Colab Notebooks/z7088012591609_5d6012928f630352cb87bf0e0d0b52ef.jpg")
